...
$query= "select * from milkstock where 1";
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-money"></i> Stock <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li class="active"><a href="milkstock.php">Milk</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Milk Stock Information <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target=".add"> Add </button>
                      <div class="modal fade add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addmilkstock.php" method="post">
                    ...
                    <br />
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="liters" id="inputSuccess4" placeholder="Liters">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><button class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
                    ...
                    <div class="modal-dialog modal-md">
                   <form class="form-label-left input_mask" enctype="multipart/form-data" action="delmilkstock.php" method="post">
                      <div class="modal-content">
                    ...
                    <br />
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="number" class="form-control has-feedback-left" name="liters" id="inputSuccess4" placeholder="How Many Liters">
