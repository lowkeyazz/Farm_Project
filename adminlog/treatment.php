  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","edittrt.php?q="+str,true);
          xmlhttp.send();
        }
</script>
  </head>
...
$query= "select * from treatment where 1";
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-desktop"></i> Health <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li class="active"><a href="treatment.php">Treatment</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Treatment Information <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target=".add"> Add </button>
                      <div class="modal fade add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addtreatment.php" method="post">
                    ...
                    <br />
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="description" id="inputSuccess4" placeholder="Description">
                      ...
                      <div class="col-md-12 col-sm-6  form-group has-feedback" style="margin-top: -1%">
                        <p>Start Date</p>
                        <input type="date" class="form-control" name="datestart" id="inputSuccess5" placeholder="Date" style="margin-top: -3%">
                      </div>
                  </div>
                        </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='deltreatment.php?id=<?php echo $stf[0] ?>&cow=<?php echo $stf[1] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        ?>
                      </tbody>
