  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","editcavs.php?q="+str,true);
          xmlhttp.send();
        }
      function agrandir(p){
        ...
        function dimin(p){
            ...
            document.getElementById(p).style.height="50px";
            document.getElementById(p).style.width="40px";
        }
</script>
  </head>
<?php
...
$query= "select * from calff where 1";
                ...
                <ul class="nav side-menu">
                  <li class="active"><a><i class="fa fa-list-alt"></i> Information <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li class="active"><a href="cavs.php">Calves</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Calf Information <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target=".add"> Add </button>
                      <div class="modal fade add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addcalf.php" method="post">
                      <div class="modal-content">

                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel">Add Calf</h4>
                    ...
                    <br />
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <select class="form-control has-feedback-left" name="insNumber" id="inputSuccess2" placeholder="Insamination No">
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="vet" id="inputSuccess2" placeholder="Vet">
                        <span class="fa fa-list form-control-feedback left" aria-hidden="true"></span>
                      </div>
                      <div class="col-md-12 col-sm-6  form-group has-feedback" style="margin-top: -1%">
                        <p>Date of Birth</p>
                        <input type="date" class="form-control" name="date" id="inputSuccess5" placeholder="Date of Birth" style="margin-top: -3%">
                      </div>
                      <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="customFile" name="image">
                    <label class="custom-file-label" for="customFile">Choose Calf Image</label>
                  </div>
                  </div>
                        </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          <td><center><img src="imagecf/<?php echo $stf[7] ?>.jpg" width="100" height="100" alt="Avatar" align="center" ></center></td>
                          ...
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delcalf.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        ?>
                      </tbody>
