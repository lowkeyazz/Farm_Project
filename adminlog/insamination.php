  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","editins.php?q="+str,true);
          xmlhttp.send();
        }
</script>
  </head>
...
$query= "select * from insamination where 1";
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-desktop"></i> Monitoring <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li class="active"><a href="insamination.php">Insamination</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Insamination Information <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target=".add"> Add </button>
                      <div class="modal fade add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addins.php" method="post">
                      <div class="modal-content">

                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel">Add insamination</h4>
                    ...
                    <br />
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <select class="form-control has-feedback-left" name="cowNumber" id="inputSuccess4" placeholder="CoNo">
                        <option value="" >Select Cow Number</option>
                            <?php 
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="number" class="form-control has-feedback-left" name="bullNumber" id="inputSuccess4" placeholder="Bull No">
                        <span class="fa fa-paw form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="vet" id="inputSuccess4" placeholder="Vet">
                        <span class="fa fa-paw form-control-feedback left" aria-hidden="true"></span>
                      </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delins.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        ?>
                      </tbody>
