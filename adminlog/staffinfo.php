  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","editstf.php?q="+str,true);
          xmlhttp.send();
        }
</script>
  </head>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addstaff.php" method="post">
                    ...
                    <br />
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="name" id="inputSuccess2" placeholder="Staff Name">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="email" class="form-control" name="email" id="inputSuccess3" placeholder="Email">
                        <span class="fa fa-envelope form-control-feedback right" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="number" id="inputSuccess4" placeholder="Mobile Number">
                        <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control" id="inputSuccess5" name="designation" placeholder="Designation">
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="password" class="form-control" name="password" id="inputSuccess3" placeholder="Password">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          <td><center><img src="image/<?php echo $stf[5] ?>.jpg" width="40" alt="Avatar" align="center"></center></td>
                          <td><?php echo $stf[1]; ?></td>
                          <td><?php echo $stf[2]; ?></td>
                          <td><?php echo $stf[3]; ?></td>
                          <td><?php echo $stf[4]; ?></td>
                          <td><?php echo $stf[6]; ?></td>
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button></form> <button onclick="if(confirm('Are you sure?')) window.location.href='delstaff.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        ?>
                      </tbody>
