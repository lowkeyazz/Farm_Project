  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","edithoof.php?q="+str,true);
          xmlhttp.send();
        }
</script>
  </head>
...
$query= "select * from hoof where 1";
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-desktop"></i> Monitoring <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li class="active"><a href="hoofing.php">Hoof Triming</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Hoof Triming <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target=".add"> Add </button>
                      <div class="modal fade add" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addhoof.php" method="post">
                      <div class="modal-content">

                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel">New Hoof</h4>
                    ...
                    <br />
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <select class="form-control" name="doneBy">
                            <option value="" >Select Staff Member</option>
                    <?php 
                        while ($st = mysqli_fetch_array(
                                $stt,MYSQLI_ASSOC)):; 
                    ?>
                    ...
                    ?>
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="cowGroup" id="inputSuccess4" placeholder="Cow Group">
                      ...
                      <tbody>
                        <?php
                          while ($stf=mysqli_fetch_row($result)) {
                            $sts = mysqli_query($connect,$queryst);
                            while ($mem = mysqli_fetch_row($sts)) {
                                if ($mem[0]==$stf[1]) {
                                    $stfm=$mem[1];
                                    break;
                                }
                        ...
                        <tr>
                          ...
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delhoof.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        ?>
                      </tbody>
