  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <script>
      function fct(str) {
          ...
          xmlhttp.open("GET","editcow.php?q="+str,true);
          xmlhttp.send();
        }
</script>
  </head>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <form class="form-label-left input_mask" enctype="multipart/form-data" action="addcow.php" method="post">
                    ...
                    <br />
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="cowType" id="inputSuccess4" placeholder="Cow Type">
                      ...
                      <div class="col-md-12 col-sm-6  form-group has-feedback" style="margin-top: -1%">
                        <p>Date of Birth</p>
                        <input type="date" class="form-control" id="inputSuccess5" name="dateOfBirth" placeholder="Date of Birth" style="margin-top: -3%">
                      </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          <td><center><img src="imagec/<?php echo $stf[4]; ?>.jpg" width="100" height="100" alt="Cow" align="center"></center></td>
                          <td><b style="color: brown"><?php echo $stf[0]; ?></b></td>
                          <td><?php echo $stf[1]; ?></td>
                          <td><?php echo $stf[2]; ?></td>
                          <td><span class="btn btn-danger btn-sm"><?php echo $stf[3]; ?></span></td>
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delcow.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php } 
                        elseif ($stf[3]=="Sick") {
                        ...
                        ?>
                        <tr>
                          <td><center><img src="imagec/<?php echo $stf[4]; ?>.jpg" width="100" height="100" alt="Avatar" align="center"></center></td>
                          <td><b style="color: brown"><?php echo $stf[0]; ?></b></td>
                          <td><?php echo $stf[1]; ?></td>
                          <td><?php echo $stf[2]; ?></td>
                          <td><span class="btn btn-warning btn-sm">Sick</span></td>
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delcow.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php } 
                        elseif ($stf[3]=="Sold") {
                        ...
                        <tr>
                          ...
                          <td><?php echo $stf[1]; ?></td>
                          <td><?php echo $stf[2]; ?></td>
                          <td><span class="btn btn-danger btn-sm">Sold</span></td>
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delcow.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }
                        elseif ($stf[3]=="Healthy") {
                        ...
                        <tr>
                          ...
                          <td><?php echo $stf[1]; ?></td>
                          <td><?php echo $stf[2]; ?></td>
                          <td><span class="btn btn-success btn-sm">Healthy</span></td>
                          <td><button onclick="fct('<?php echo $stf[0]; ?>')" class="btn btn-info btn-sm"  data-toggle="modal" data-target=".edit"><i class="fa fa-pencil"></i></button> <button onclick="if(confirm('Are you sure?')) window.location.href='delcow.php?id=<?php echo $stf[0] ?>';" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        <?php }} ?>
                      </tbody>
