                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <br />
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Food Item">
                        <span class="fa fa-paw form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Remarks">
                        <span class="fa fa-edit form-control-feedback left" aria-hidden="true"></span>
                      </div>
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                       <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Quality">
                      ...
                      <div class="col-md-4 col-sm-3  form-group has-feedback" style="margin-top: -1%">
                        <p>Feeding Time</p>
                        <input type="time" class="form-control" id="inputSuccess5" placeholder="" style="margin-top: -3%">
                      </div>
                  </div>
                        </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td><b style="color: brown">12333-2323</b></td>
                          <td>10/10/20</td>
                          <td>Data</td>
                          <td>Bermoda Grass</td>
                          <td>Brand New</td>
